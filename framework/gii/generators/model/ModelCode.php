...
class ModelCode extends CCodeModel
{
	...
	public function validateTableName($attribute,$params)
	{
        ...
        Yii::log('come here', CLogger::LEVEL_WARNING, 'php');
		...
		{
            Yii::log('checking', CLogger::LEVEL_WARNING, 'php');
	...
	public function checkColumns($table)
	{
		...
		{
            Yii::log($table->name, CLogger::LEVEL_WARNING, 'php');
            Yii::log($column->name, CLogger::LEVEL_WARNING, 'php');
