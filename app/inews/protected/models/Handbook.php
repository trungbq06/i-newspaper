 ...
 *
 * The followings are the available columns in table 'handbook':
 * @property integer $id
 ...
 */
class Handbook extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('title, headline, content, created_time, published_time, thumbnail_url, original_url, thumbnail', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, title, headline, content, created_time, published_time, thumbnail_url, original_url, thumbnail', 'safe', 'on'=>'search'),
		);
	}
	...
	public static function isExist($articleUrl) {
		...
		$news = Handbook::model()->findAll($criteria);
