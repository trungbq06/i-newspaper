...
class News extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, title, title_en, headline, headline_en, content, content_en, thumbnail_url, category_id, site_id, published_time, created_time, original_url', 'safe', 'on'=>'search'),
		);
	}
